...
public class KafkaConfig {
    ...
    //TODO: Check how to configure container with Object, and still load configuration from properties file
/*    @Bean
    ConcurrentKafkaListenerContainerFactory<String, OrderMessage> kafkaListenerContainerFactory(
    ...
    private ConsumerFactory<String, OrderMessage> consumerFactory() {
        ...
        config.put(GROUP_ID_CONFIG, "group.xx.order");
